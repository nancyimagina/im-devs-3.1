  ...
  head: () => ({
    meta: [
      ...
      { title: "Imagina Devs — Nearshore Engineering Teams for U.S. Companies" },
      {
        name: "description",
        content:
          "Senior nearshore engineering talent and custom software development for U.S. companies.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&display=swap",
      },
